  ...
  <div class="col-12 col-md-6 p-5">
    ...
    <form class="" action="../controller/ajout-patient-rendez-vous.php" method="POST">
      ...
      <div class="mt-3">
        ...
        <?php if(isset($error6)) : ?>
          <aside class="text-danger"><?php echo $error6; ?></aside>
        <?php endif; ?>
      </div>
      <input class="form-control btn btn-dark text-white my-2" name="addPatientRendezvous" type="submit" value="Enregistrer">
    </form>
    <div class="mt-3">
